...
counterparts. This reflects not practical convenience but the
insensitivity of the objective itself to the short-run deviations that
would otherwise trigger rebalancing.
...
These two filters serve as more than illustrations: they are the
operations that distinguish the two paradigms of
